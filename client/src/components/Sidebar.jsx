...
const Sidebar = ({ isMenuOpen, setIsMenuOpen, isSidebarOpen, setIsSidebarOpen }) => {
...
rounded-md cursor-pointer flex justify-between group"
                        >
                            ...
                            <img
                                src={assets.bin_icon}
                                className="block w-4 cursor-pointer not-dark:invert"
                                onClick={(e) =>
            ...
            <div className="flex items-center gap-3 p-3 mt-4 border border-gray-300 dark:border-white/15 rounded-md cursor-pointer group">
                ...
                {user && (
                    <img
                        ...
                        className="h-5 cursor-pointer block not-dark:invert"
                    />
                )}
            </div>
